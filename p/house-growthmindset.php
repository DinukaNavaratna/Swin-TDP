    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="house-growthmindset.php" class="active">
              <i class="bi bi-circle"></i><span>Growth Mindset</span>
            </a>
          </li>
        </ul>
...
<section class="section">
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Avarage Growth Mindset Score</h5>
          <!-- Vertical Bar Chart -->
          <div id="growthmindset" style="min-height: 500px;" class="echart"></div>

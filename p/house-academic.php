    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          <li>
            <a href="house-academic.php" class="active">
              <i class="bi bi-circle"></i><span>Academic Performance</span>
            </a>
          </li>
          <li>
...
<section class="section">
  <div class="row">
    <div class="col-lg-6">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Academic Results and Attendance</h5>
          <!-- Vertical Bar Chart -->
          <div id="academic_attendance" style="min-height: 500px;" class="echart"></div>
      ...
      <div class="card">
        <div class="card-body"><br>
          ...
          <table class="table table-hover">
            ...
            <tbody id="academic_attendance_tbl">
            </tbody>
          </table>
...
<section class="section">
  <div class="row">
    <div class="col-lg-6">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Language Spoken</h5>
          <!-- Vertical Bar Chart -->
...
<section class="section">
  <div class="row">
    <div class="col-lg-6">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Academic Results and Language</h5>
          <!-- Vertical Bar Chart -->
          <div id="academic_language" style="min-height: 500px;" class="echart"></div>
          <!-- End Vertical Bar Chart -->
        </div>
      </div>
      ...
      <div class="card">
        <div class="card-body">
          ...
          <table class="table table-hover">
            ...
            <tbody id="academic_language_tbl">
            </tbody>
          </table>
          <!-- End Table with hoverable rows -->
        </div>

...
<body>
        ...
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              ...
              <div id="disrespect_sna" style="min-height: 500px;" class="echart"></div>
            </div>
          </div>
        </div>
    </section>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Disrespectees</h5>
              ...
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">No of Disrespecters</th>
                  </tr>
                </thead>
                <tbody id="disrespectee_tbl">
                </tbody>
              </table>
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Disrespecters</h5>
              <!-- Table with hoverable rows -->
              <table class="table table-hover">
                <thead>
                  <tr>
                    ...
                    <th scope="col">First Name</th>
                    <th scope="col">Last Name</th>
                    <th scope="col">No of Disrespectees</th>
                  </tr>
                </thead>
                <tbody id="disrespecter_tbl">
                </tbody>
              </table>
              <!-- End Table with hoverable rows -->
            </div>
  ...
  <script src="disrespect.js"></script>
  <script>
    getdata("1");
  </script>

    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="house-manbox.php" class="active">
              <i class="bi bi-circle"></i><span>Manbox</span>
            </a>
          </li>
          <li>
...
<section class="section">
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Average Manbox Score</h5>
          <!-- Vertical Bar Chart -->
          <div id="manbox" style="min-height: 500px;" class="echart"></div>
...
<section class="section">
  <div class="row">
    <div class="col-lg-6">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Manbox Score and Language</h5>
          <!-- Vertical Bar Chart -->

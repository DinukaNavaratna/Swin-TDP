...
function abnormal(abnormal) {
    ...
    for (var student of abnormal) {
        tbl += "<tr onclick=\"window.open('student.php?sid="+student[6]+"&survey="+surveynum+"', '_self')\"><td>" + student[0] + "</td><td>" + student[1] + "</td><td>" + student[2] + "</td><td>" + student[3] + "</td><td>" + student[4] + "</td><td>" + student[5] + "</td></tr>";
    }
    $("#abnormal").html(tbl);
}

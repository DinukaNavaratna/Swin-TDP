...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Individual Student Network Analysis</h1>
      <nav>
      </nav>
    </div><!-- End Page Title -->
    <br>
          ...
          <div class="card">
            <div class="card-body">
              <div class="row">
                ...
                <div class="col-lg-3">
                  <h5 class="card-title">Select Survey</h5>
                  <select class="form-select" aria-label="Select a survey" id="survey">
                    <option selected disabled>Select a survey</option>
                    <option value="1">Survey 01</option>
                    <option value="2">Survey 02</option>
                  </select>
                </div>
                <div class="col-lg-3">
                  <h5 class="card-title">Enter Participant ID</h5>
                  <div class="col-sm-12">
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"></h5>
              <div id="student_sna" style="min-height: 600px;" class="echart"></div>
            </div>
          </div>
        </div>
      </div>

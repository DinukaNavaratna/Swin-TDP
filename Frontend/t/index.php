            ...
            <div class="row">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ps-3">
                        ...
                        <span class="text-success small pt-1 fw-bold" id="hcompleted">0</span>
                ...
                <div class="card info-card customers-card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ps-3">
                        <h6 id="incomplete">0</h6>
                        <span class="text-danger small pt-1 fw-bold" id="hincomplete">0</span>
                ...
                <div class="card info-card revenue-card">
                  ...
                  <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ps-3">
                        <h6 id="total">0</h6>
                        <span class="text-success small pt-1 fw-bold" id="htotal">0</span>
              ...
              <div class="col-12">
                <div class="card">
                  ...
                  <div class="card-body">
                    <h5 class="card-title">Students from House Who Haven't Completed the Survey</h5>
          ...
          <div class="col-lg-4">
            ...
            <div class="card">
              ...
              <div class="card-body pb-0">
                ...
                <div id="stuparticipation" style="min-height: 400px;" class="echart"></div>
            ...
            <div class="card">
              <div class="card-body pb-0">
                <h5 class="card-title">Student feedback <span id="comm_count">(0/0)</span><span style="float:right;"><span id="comm_b" style="cursor:pointer;"><<</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span id="comm_n" style="cursor:pointer;">>></span>
                    </span></h5>

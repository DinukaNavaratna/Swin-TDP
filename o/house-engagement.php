...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="house-engagement.php" class="active">
              <i class="bi bi-circle"></i><span>School Engagement</span>
            </a>
          </li>
          <li>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>School Engagement Analysis</h1>
      <nav>
        <ol class="breadcrumb">
...
<section class="section">
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Average School Engagement Score</h5>
          <!-- Vertical Bar Chart -->
          <div id="engagement" style="min-height: 500px;" class="echart"></div>
...
<section class="section">
  <div class="row">
    <div class="col-lg-6">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">School Engagement and Language</h5>
          <!-- Vertical Bar Chart -->

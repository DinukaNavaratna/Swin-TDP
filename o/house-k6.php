    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="house-k6.php" class="active">
              <i class="bi bi-circle"></i><span>K6</span>
            </a>
          </li>
          <li>
...
<section class="section">
  <div class="row">
    <div class="col-lg-6">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Average K6 Score</h5>
          <!-- Vertical Bar Chart -->
          <div id="k6_score" style="min-height: 500px;" class="echart"></div>
    ...
    <div class="col-lg-6">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Number of Students above K6 Borderline</h5>
          <!-- Vertical Bar Chart -->
          <div id="k6_problem" style="min-height: 500px;" class="echart"></div>
          <!-- End Vertical Bar Chart -->
        </div>
      </div>
...
<section class="section">
  <div class="row">
    <div class="col-lg-6">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">K6 Score and Language</h5>
          <!-- Vertical Bar Chart -->
...
<section class="section">
  <div class="row">
    <div class="col-lg-12">
      ...
      <div class="card">
        <div class="card-body">
          <h5 class="card-title">Students with K6 Problems</h5>
          <!-- Table with hoverable rows -->
          <table class="table table-hover">
            <thead>
              <tr>
                ...
                <th scope="col">K6 Score</th>
              </tr>
            </thead>
            <tbody id="k6_problem_list_tbl">
            </tbody>
          </table>
          <!-- End Table with hoverable rows -->
        </div>
  ...
  <script src="k6.js"></script>
  <script>getdata("2", "h");</script>
